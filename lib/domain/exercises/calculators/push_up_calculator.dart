...
class PushUpCalculator implements ExerciseCalculator {
  ...
  ExerciseFrameResult? update({
    ...
    if (lifecycleEvent.didEndSet) {
      // Guard against accidental extra rep at set end.
      _repPhase = ExerciseRepPhase.unknown;
    }

    // TODO: implement push-up rep counting using pose landmarks + angles.
    // Only count reps while `_lifecycle.stage == ExerciseSetStage.active`.
